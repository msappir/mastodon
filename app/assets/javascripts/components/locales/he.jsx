const he = {
  ...
  "account.disclaimer": "משתמש זה מגיע משרת אחר. המספר הזה עשוי להיות גדול יותר.",
  "account.edit_profile": "עריכת פרופיל",
  "account.follow": "לעקוב",
  "account.followers": "עוקבים",
  "account.follows_you": "בעקיבה אחריך",
  "account.follows": "במעקב",
  "account.mention": "פניה ל-@{name}",
  "account.mute": "להשתיק את @{name}",
  "account.posts": "הודעות",
  "account.report": "לדווח על @{name}",
  "account.requested": "בהמתנה לאישור",
  "account.unblock": "ביטול חסימת @{name}",
  "account.unfollow": "ביטול מעקב",
  "account.unmute": "ביטול השתקת @{name}",
  ...
  "empty_column.hashtag": "אין כלום על ההאשטאג הזה עדיין.",
  "empty_column.home.public_timeline": "בפרהסיה",
  "empty_column.home": "אף אחד לא במעקב עדיין. אפשר לבקר ב{public} או להשתמש בחיפוש כדי להתחיל ולהכיר אנשים אחרים.",
  "empty_column.notifications": "אין התראות עדיין. יאללה, הגיע הזמן להתערבב!",
  "empty_column.public": "אין פה כלום! כדי למלא את הטור הזה אפשר לכתוב משהו, או להתחיל לעקוב אחרי אנשים משרתים אחרים.",
  "follow_request.authorize": "קבלה",
  "follow_request.reject": "דחיה",
  "getting_started.apps": "קיימים מבחר ישומים",
  "getting_started.heading": "על ההתחלה",
  "getting_started.open_source_notice": "מסטודון היא תוכנה בקוד פתוח. ניתן לתרום או לדווח על בעיות בגיטהאב: {github}. {apps}.",
  "home.column_settings.advanced": "למתקדמים",
  "home.column_settings.basic": "בסיסי",
  "home.column_settings.filter_regex": "סינון החוצה באמצעות ביטויים רגילים לחלוטין (regular expressions)",
  "home.column_settings.show_reblogs": "הצגת הדהודים",
  "home.column_settings.show_replies": "הצגת תגובות",
  "home.settings": "הגדרות טור",
  "lightbox.close": "סגירה",
  "loading_indicator.label": "נטען...",
  ...
  "notification.mention": "קיבלת פניה מ-{name}",
  ...
  "privacy.unlisted.long": "פומבי, אל לא להצגה בפרהסיה",
  "privacy.unlisted.short": "לא רשום",
  "reply_indicator.cancel": "ביטול",
  "report.heading": "דיווח חדש",
